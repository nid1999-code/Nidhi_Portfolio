    ...
    <div className={classes["aboutme-container"]} id="about">
      ...
      <div className={classes.para}>
        <p>
          ...
          of purposes. I am always looking for ways to create something new. I
          like solving problems and really like to learn about DSA. There are
          various web technologies I like working with such as reactjs, nodejs.
        </p>
      </div>
